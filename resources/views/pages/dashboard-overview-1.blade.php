            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex items-center h-10">
                        ...
                        if ($yetkiid==1)
                        {?>
                        <img src="app\data\images\bakanlik.png" alt="Bakanlık Yönetim Konsolu">
                    <?php
                    }
                    elseif ($yetkiid==2) {
                        ?>
                        <img src="app\data\images\iltarim.png" alt="İl Tarım Yönetim Konsolu">
                    <?php } 
                    elseif ($yetkiid==0) {?>
                        <img src="app\data\images\admin.png" alt="Yönetici Konsol">
                    <?php
                    }
                     elseif ($yetkiid==3) {
                     ?>
                      <img src="app\data\images\danisman.png" alt="Danışman Yönetim Konsolu">
                       <?php
                       }
                       elseif ($yetkiid==4) {
                       ?>
                       <img src="app\data\images\ciftci.png" alt="Çiftçi Yönetim Sistemi">
                       <?php
                        }
                       ?>
