...
@section('subhead')
    <title>Ürün Türü Ekleme</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
            <h2 class="text-lg font-medium mr-auto">Ürün Türü Ekleme</h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input id="crud-form-1" type="text" name="urunturu" class="form-control w-full" placeholder="Yazınız">
                </div>
