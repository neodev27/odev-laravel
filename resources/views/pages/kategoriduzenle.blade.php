...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Kategori Düzenleme</h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-6">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input name="urunturu" id="crud-form-1" value="{{ $kategori->urunturu }}" type="text" class="form-control w-full" placeholder="Yazınız">
                </div>
